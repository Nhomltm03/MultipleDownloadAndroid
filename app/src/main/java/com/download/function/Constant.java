...
public class Constant {
    ...
    public static final String MULTITHREADING_DOWNLOAD_FAILED = "Multithreading download failed!";
    public static final String MULTITHREADING_DOWNLOAD_CANCEL = "Multithreading download cancel!";
    public static final String MULTITHREADING_DOWNLOAD_FINISH = "Multithreading download finish!";

    public static final String ALREADY_DOWNLOAD_HINT = "File already downloaded!";

    //Range download hint
    public static final String RANGE_DOWNLOAD_STARTED = "Range %d start download from [%d] to [%d]";
