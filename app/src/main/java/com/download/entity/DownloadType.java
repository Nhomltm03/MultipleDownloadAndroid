...
import static com.download.function.Constant.ALREADY_DOWNLOAD_HINT;
import static com.download.function.Constant.CONTINUE_DOWNLOAD_CANCEL;
import static com.download.function.Constant.CONTINUE_DOWNLOAD_COMPLETED;
import static com.download.function.Constant.CONTINUE_DOWNLOAD_FAILED;
import static com.download.function.Constant.CONTINUE_DOWNLOAD_FINISH;
import static com.download.function.Constant.CONTINUE_DOWNLOAD_PREPARE;
import static com.download.function.Constant.CONTINUE_DOWNLOAD_STARTED;
import static com.download.function.Constant.MULTITHREADING_DOWNLOAD_CANCEL;
import static com.download.function.Constant.MULTITHREADING_DOWNLOAD_COMPLETED;
import static com.download.function.Constant.MULTITHREADING_DOWNLOAD_FAILED;
import static com.download.function.Constant.MULTITHREADING_DOWNLOAD_FINISH;
import static com.download.function.Constant.MULTITHREADING_DOWNLOAD_PREPARE;
import static com.download.function.Constant.MULTITHREADING_DOWNLOAD_STARTED;
import static com.download.function.Constant.NORMAL_DOWNLOAD_CANCEL;
import static com.download.function.Constant.NORMAL_DOWNLOAD_COMPLETED;
import static com.download.function.Constant.NORMAL_DOWNLOAD_FAILED;
import static com.download.function.Constant.NORMAL_DOWNLOAD_FINISH;
import static com.download.function.Constant.NORMAL_DOWNLOAD_PREPARE;
import static com.download.function.Constant.NORMAL_DOWNLOAD_STARTED;
import static com.download.function.Constant.NORMAL_RETRY_HINT;
import static com.download.function.Constant.RANGE_RETRY_HINT;
    ...
    public static class ContinueDownload extends DownloadType {
        ...
        private Publisher<DownloadStatus> rangeDownload(final int index) {
            return record.rangeDownload(index)
                    ...
                    .flatMap((Function<Response<ResponseBody>, Publisher<DownloadStatus>>) response -> save(index, response.body()))
                    .compose(Utils.retry2(formatStr(RANGE_RETRY_HINT, index), record.getMaxRetryCount()));
        }
        ...
        private Publisher<DownloadStatus> save(final int index, final ResponseBody response) {
            ...
            return Flowable.create(emitter -> record.save(emitter, index, response), BackpressureStrategy.LATEST);
        }
    }
